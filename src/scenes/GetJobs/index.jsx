...
import { fetchAllJobs, toggleJobActivation, deleteJob, fetchJobAnalytics, createJob, updateJob } from "../../Api/adminApi";
  ...
  return (
    ...
    <Box sx={{ height: "87vh", overflowY: "auto", padding: "20px" }}>
      ...
      <Box>
        ...
        {/* Add Job Button - positioned after stat boxes and before job cards */}
      ...
      <>
        ...
        <CRUDModal
          ...
          mode={crudMode}
          title={`${crudMode === 'create' ? 'Add' : crudMode === 'edit' ? 'Edit' : 'Delete'} Job`}
          initialData={selectedJob}
          fields={[
            { name: 'jobTitle', label: 'Job Title', required: true },
            { name: 'workplaceType', label: 'Workplace Type', required: true },
            { name: 'salaryRange', label: 'Salary Range', required: true },
            { name: 'applicationDeadline', label: 'Application Deadline', required: true },
            { name: 'description', label: 'Description', required: true },
            { name: 'requirements', label: 'Requirements', required: true },
