...
import TotalInvestorUser from '../UserProfile/InvestorUser/TotalInvestorUser';
...
const TotalInvestor = () => {
  ...
  if (selectedUser) {
    return <TotalInvestorUser user={selectedUser} onBack={handleBackClick} />;
  }
    ...
    <Box m="20px">
      <Box component={Paper} backgroundColor={colors.primary[400]}>
        <Box display="flex" alignItems="center" mb={2}>
          <IconButton onClick={HandleInvestor}>
            <ArrowBackIcon />
          </IconButton>
        </Box>
