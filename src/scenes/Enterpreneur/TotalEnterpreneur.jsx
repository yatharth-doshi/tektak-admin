...
import TotalEnterpreneurUser from '../UserProfile/EnterpreneurUser/TotalEnterpreneurUser';
...
const TotalEnterpreneur = () => {
  ...
  if (selectedUser) {
    return <TotalEnterpreneurUser user={selectedUser} onBack={handleBackClick} />;
  }
    ...
    <Box m="20px">
      <Box component={Paper} backgroundColor={colors.primary[400]}>
        <Box display="flex" alignItems="center" mb={2}>
          <IconButton onClick={HandleEnterpreneur}>
            <ArrowBackIcon />
          </IconButton>
        </Box>
...
export default TotalEnterpreneur;
