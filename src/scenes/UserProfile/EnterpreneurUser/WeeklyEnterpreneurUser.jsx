...
const WeeklyEnterpreneurUser = ({ user, onBack }) => {
    ...
    const handlepodcast = () => {
        navigate('/weeklyenterpreneurpodcast')
    }
    const handlevideo =() => {
        navigate('/weeklyenterpreneurvideo')
    }
    const handlejobs =() => {
        navigate('/weeklyenterpreneurjobs')
    } 
    const handleevents =() => {
        navigate('/weeklyenterpreneurevents')
    }
    return (
...
export default WeeklyEnterpreneurUser;
