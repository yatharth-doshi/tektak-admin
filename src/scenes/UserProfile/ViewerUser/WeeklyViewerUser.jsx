...
const WeeklyViewerUser = ({ user, onBack }) => {
    ...
    const handlepodcast = () => {
        navigate('/weeklyviewerpodcast')
    }
    const handlevideo=()=> {
        navigate('/weeklyviewervideo')
    }
    const handlejobs=()=> {
        navigate('/weeklyviewerjobs')
    }
    const handleevents=()=> {
        navigate('/weeklyviewerevents')
    }
    return (
...
export default WeeklyViewerUser;
