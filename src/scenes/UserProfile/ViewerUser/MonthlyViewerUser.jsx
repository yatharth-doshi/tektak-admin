...
const MonthlyViewerUser = ({ user, onBack }) => {
    const theme = useTheme();
    const colors = tokens(theme.palette.mode);
    const navigate = useNavigate();

    const handledailyviewer = () => {
        navigate('/monthlyViewer');
    };
    const handlepodcast =() => {
        navigate('/monthlyviewerpodcast')
    }
    const handlevideo=()=> {
        navigate('/monthlyviewervideo')
    }
    const handlejobs=()=> {
        navigate('/monthlyviewerjobs')
    }
    const handleevents=()=> {
        navigate('/monthlyviewerevents')
    }
...
export default MonthlyViewerUser;
