...
const DailyEnterpreneurUser = ({ user, onBack }) => {
    ...
    const handlepodcast =() => {
        navigate('/dailyviewerpodcast')
    }
    const handlevideo=()=> {
        navigate('/dailyviewervideo')
    }
    const handlejobs=()=> {
        navigate('/dailyviewerjobs')
    }
    const handleevents=()=> {
        navigate('/dailyviewerevents')
    }
...
export default DailyEnterpreneurUser;
