...
const TotalViewerUser = ({ user, onBack }) => {
    const theme = useTheme();
    const colors = tokens(theme.palette.mode);
    const navigate = useNavigate();

    const handletotalviewer = () => {
        navigate('/totalyViewer');
    };
    const handlepodcast =() => {
        navigate('/totalviewerpodcast')
    }
    const handlevideo=()=> {
        navigate('/totalviewervideo')
    }
    const handlejobs=()=> {
        navigate('/totalviewerjobs')
    }
    const handleevents=()=> {
        navigate('/totalviewerevents')
    }
    return (
...
export default TotalViewerUser;
