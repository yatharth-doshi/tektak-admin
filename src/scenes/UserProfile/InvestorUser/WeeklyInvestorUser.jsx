...
const WeeklyInvestorUser = ({ user, onBack }) => {
    ...
    const handleweeklyPodcast =() => {
        navigate('/weeklyinvestorpodcast')
    }
    const handlevideo = () => {
        navigate('/weeklyinvestorvideo');
    };
    const handlejobs = () => {
        navigate('/weeklyinvestorjobs');
    };
    const handleevents = () => {
        navigate('/weeklyinvestorevents');
    };
    return (
        <Box width="90%" mx="auto" my="30px" gap="20px">
            ...
            >
                ...
                <Box backgroundColor={colors.primary[400]} display="flex" alignItems="center" justifyContent="center" boxShadow="0 3px 10px rgba(0, 0, 0, 0.2)" onClick={handleweeklyPodcast}>
                    <StatBox
...
export default WeeklyInvestorUser;
