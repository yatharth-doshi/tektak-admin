...
const MonthlyInvestorUser = ({ user, onBack }) => {
    const theme = useTheme();
    const colors = tokens(theme.palette.mode);
    const navigate = useNavigate();

    const handledailyinvestor = () => {
        navigate('/dailyinvestor');
    };
    const handlevideo = () => {
        navigate('/monthlyinvestorvideo');
    };
    const handlejobs = () => {
        navigate('/monthlyinvestorjobs');
    };
    const handleMonthlyPodcast = () => {
        navigate('/monthlyinvestorpodcast')
    }
    const handleevents = () => {
        navigate('/monthlyinvestorevents')
    }
    ...
    return (
        <Box width="90%" mx="auto" my="30px" gap="20px">
            ...
            >
                ...
                <Box backgroundColor={colors.primary[400]} display="flex" alignItems="center" justifyContent="center" boxShadow="0 3px 10px rgba(0, 0, 0, 0.2)" onClick={handleMonthlyPodcast} >
                    <StatBox
...
export default MonthlyInvestorUser;
