...
const TotalInvestorUser = ({ user, onBack }) => {
    const theme = useTheme();
    const colors = tokens(theme.palette.mode);
    const navigate = useNavigate();

    const handletotalinvestor = () => {
        navigate('/totalyinvestor');
    };
    const handletotalPodcast =() => {
        navigate('/totalinvestorpodcast')
    }
    const handlevideo = () => {
        navigate('/totalinvestorvideo');
    };
    const handlejobs = () => {
        navigate('/totalinvestorjobs');
    };
    const handleevents = () => {
        navigate('/totalinvestorevents');
    };
    ...
    return (
        <Box width="90%" mx="auto" my="30px" gap="20px">
            ...
            >
                ...
                <Box backgroundColor={colors.primary[400]} display="flex" alignItems="center" justifyContent="center" boxShadow="0 3px 10px rgba(0, 0, 0, 0.2)" onClick={handletotalPodcast}>
                    <StatBox
...
export default TotalInvestorUser;
